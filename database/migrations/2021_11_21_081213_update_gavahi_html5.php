...
class UpdateGavahiHtml5 extends Migration
{
...
@foreach($data as $key=>$item)
        ...
        <table>
            <tr>
                ...
                <td style="width:350px;font-weight: bold;text-align:center;vertical-align: top;font-size:19px;"><span
                    ...
                    <div>اداره کل پست استان {{$item["statename"]}}-منطقه ۱۵ پستی</div>
    ...
    <table style="border:1px solid black;border-top:none;min-width:100%;min-height:400px;max-height: 400px">
        @if($item["image_exists"])
            <tr>
                <td><img src="var:{{$key}}"></td>
            </tr>
        @endif
    </table>
    {{--</div>--}}
